    ...
    SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        return http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers(HttpMethod.GET, "/api/v1/tipos-habitacion/**").permitAll()
                        .requestMatchers(HttpMethod.POST, "/api/v1/tipos-habitacion/**").hasRole("ADMIN")
                        .requestMatchers(HttpMethod.PUT, "/api/v1/tipos-habitacion/**").hasRole("ADMIN")
                        .requestMatchers(HttpMethod.DELETE, "/api/v1/tipos-habitacion/**").hasRole("ADMIN")
